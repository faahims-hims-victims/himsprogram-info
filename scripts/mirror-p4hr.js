...
function enhanceSEO(html, route) {
  const seoHead = `
    ...
    <meta property="og:image" content="https://himsprogram.info/assets/og-image.jpg">
    ...
    <meta name="twitter:image" content="https://himsprogram.info/assets/twitter-card.jpg">
